...
@Service
public class FieldconstantsCommands implements CommandMarker { // All command types must implement the CommandMarker interface
	
	/**
	 * Get a reference to the FieldconstantsOperations from the underlying OSGi container
	 */
	@Reference private FieldconstantsOperations operations;
	 ...
	 */
	@CliAvailabilityIndicator({ "fieldconstants setup", "fieldconstants add", "fieldconstants all" })
	 ...
	 * @param type 
	 */
	@CliCommand(value = "fieldconstants add", help = "Some helpful description")
	 ...
	 * 
	 */
	@CliCommand(value = "fieldconstants all", help = "Some helpful description")
	public void all() {
